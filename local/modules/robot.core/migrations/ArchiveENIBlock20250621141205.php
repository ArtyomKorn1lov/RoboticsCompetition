...
class ArchiveENIBlock20250621141205 extends Version
{
    protected $author = "admin";

    protected $description = "ИБ - архив - англ. версия";
    ...
    public function up()
    {
        ...
        $iblockId = $helper->Iblock()->saveIblock(array(
            ...
            'RSS_FILE_DAYS' => NULL,
            'RSS_YANDEX_ACTIVE' => 'N',
            'XML_ID' => 'd73d895b-5824-487c-b6cd-6830018edaa2',
            'INDEX_ELEMENT' => 'Y',
            'INDEX_SECTION' => 'Y',
            'WORKFLOW' => 'N',
            'BIZPROC' => 'N',
            ...
            'EXTERNAL_ID' => 'd73d895b-5824-487c-b6cd-6830018edaa2',
            'LANG_DIR' => '/en/',
            'IPROPERTY_TEMPLATES' =>
                array(),
        ...
        $helper->Iblock()->saveProperty($iblockId, array(
            ...
            'LIST_TYPE' => 'L',
            'MULTIPLE' => 'Y',
            'XML_ID' => 'e6368b7a-aa29-41a6-9fd6-cb33fd84bb1e',
        ...
        $helper->Iblock()->saveProperty($iblockId, array(
            ...
            'LIST_TYPE' => 'L',
            'MULTIPLE' => 'Y',
            'XML_ID' => '5641c6bd-e84c-4441-ad54-116caf251e6e',
            'FILE_TYPE' => 'jpg, gif, bmp, png, jpeg, webp',
            'MULTIPLE_CNT' => '5',
            'LINK_IBLOCK_ID' => '0',
            'WITH_DESCRIPTION' => 'N',
        ...
        $helper->Iblock()->saveProperty($iblockId, array(
            ...
            'LIST_TYPE' => 'L',
            'MULTIPLE' => 'Y',
            'XML_ID' => 'c4f76a85-ef68-4afa-b3d1-b2fa0678f73a',
        ...
        $helper->UserOptions()->saveElementForm($iblockId, array(
            'Параметры|edit1' =>
                array(
                    ...
                    'PROPERTY_VIDEO_LINKS' => 'Ссылки на видео',
