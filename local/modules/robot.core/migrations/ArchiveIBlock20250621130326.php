...
class ArchiveIBlock20250621130326 extends Version
{
    protected $author = "admin";

    protected $description = "ИБ - архив - осн. версия";
    ...
    public function up()
    {
        ...
        $helper->Iblock()->saveProperty($iblockId, array(
            ...
            'HINT' => 'Загруженные превью для видео в том же порядке, что и ссылки на видео и видео-файлы (сначала идут ссылки на видео, а затем видео-файлы)',
            'FEATURES' =>
                array(
                    0 =>
                        array(
        ...
        $helper->Iblock()->saveProperty($iblockId, array(
            ...
            'LIST_TYPE' => 'L',
            'MULTIPLE' => 'Y',
            'XML_ID' => '5ba532d6-c0c4-4ab9-99c8-c24d858253f6',
            'FILE_TYPE' => '',
            'MULTIPLE_CNT' => '5',
            'LINK_IBLOCK_ID' => '0',
            'WITH_DESCRIPTION' => 'N',
            ...
            'USER_TYPE' => NULL,
            'USER_TYPE_SETTINGS' => 'a:0:{}',
            'HINT' => 'Ссылки на видео (Youtube, Rutube, VK-видео)',
            'FEATURES' =>
                array(
                    0 =>
                        array(
